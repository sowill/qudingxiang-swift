...
class QDXHomeViewController: QDXBaseViewController{
    ...
    init()
    {
        ...
        self.tabBarItem.image = UIImage(named: "index_home_nomal")?.withRenderingMode(.alwaysOriginal)
        self.tabBarItem.selectedImage = UIImage(named: "index_home_click")?.withRenderingMode(.alwaysOriginal)
    }
